...
@Deprecated
class DeprecatedAcceptRunner extends BlockJUnit4ClassRunner {
    ...
    public DeprecatedAcceptRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
    ...
    private void validateRootFolder() {
        ...
        if (folder == null) {
            throw new RuntimeException("\nInvalid configuration of DeprecatedAcceptRunner.\n" +
                    "Missing @RootFolder annotation\n" +
                    "Example of correct usage:\n" +
                    "  @RunWith(DeprecatedAcceptRunner.class)\n" +
